...
FLOPS_WARMUP=2000  # 2000 / 4 = 500 steps
LORA_R=16
LORA_ALPHA=32
TRAIN_BATCH_SIZE=16  # 16x8x16=2048 effective batch size, 1130 steps per epoch
GRADIENT_ACCUMULTATION_STEPS=4
LR_SCHEDULER_TYPE=cosine
LR=1e-4
NUM_TRAIN_EPOCHS=1
SAVE_AS=llama3_8b_bi_pretrain_epoch1
RUN_NAME=llama3_8b_bi_pretrain_epoch1
