...
LR=5e-5
NUM_TRAIN_EPOCHS=2
SAVE_AS=llama3_3b_bi_pretrained_flops_q${Q_FLOPS_FACTOR}_p${P_FLOPS_FACTOR}_bs${TRAIN_BATCH_SIZE}_ga${GRADIENT_ACCUMULTATION_STEPS}_lora${LORA_R}_lr${LR}
RUN_NAME=llama3_3b_bi_pretrained_flops_q${Q_FLOPS_FACTOR}_p${P_FLOPS_FACTOR}_bs${TRAIN_BATCH_SIZE}_ga${GRADIENT_ACCUMULTATION_STEPS}_lora${LORA_R}_lr${LR}
