...
class TevatronTrainer(Trainer):
    ...
    def _save(self, output_dir: Optional[str] = None, state_dict=None):
        """
        https://github.com/huggingface/transformers/blob/298b3f19303294293f7af075609481d64cb13de3/src/transformers/trainer.py#L3906
        """
    ...
    def _get_train_sampler(self) -> Optional[torch.utils.data.Sampler]:
        """
        this is a simplified version of trainer._get_train_sampler
        https://github.com/huggingface/transformers/blob/6e535425feae20ca61a8b10ae5e8a7fab4d394ba/src/transformers/trainer.py#L657
        """
        from packaging import version

        _is_torch_generator_available = True if version.parse(torch.__version__) >= version.parse("1.6") else False
    ...
    def compute_loss(self, model: PreTrainedModel, inputs: torch.Tensor) -> torch.Tensor:
