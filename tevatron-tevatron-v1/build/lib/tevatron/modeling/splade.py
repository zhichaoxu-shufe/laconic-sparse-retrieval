...
class SpladeModelForCausalLM(DecoderModel):
    ...
    def encode_query(self, qry):
        ...
        # aggregated_psg_out, _ = torch.max(
        #     torch.nn.functional.softplus(qry_out) * qry["attention_mask"].unsqueeze(-1),
        #     dim=1,
        # )
...
class SpladeModelForMamba2(DecoderModel):
    from mamba_ssm import MambaLMHeadModel

    TRANSFORMER_CLS = MambaLMHeadModel
