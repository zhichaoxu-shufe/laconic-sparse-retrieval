...
class MNTPTrainer(Trainer):
    ...
    def _save(self, output_dir: Optional[str] = None, state_dict=None):
        ...
        # model organization is MODEL_TYPEBiForMNTP.model -> MODEL_TYPELBiModel, we have to save the inner model, 
        # handled by save_peft_model function of the outer model

        # it seems save_peft_model is not compatible with accelerate + FSDP
...
def main():
    ...
    # send_example_telemetry("run_mlm", model_args, data_args)  # commented out for transformers==4.57.0 
